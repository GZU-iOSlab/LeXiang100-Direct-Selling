...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        scrollview.contentSize=CGSizeMake(viewWidth, viewHeight*1.2);
        ...
        //适用对象标题
        UILabel * user = [[[UILabel alloc]initWithFrame:CGRectMake(0, 0, viewWidth, viewHeight/30)]autorelease];
        user.text = @"   适用对象";
        //user.font=font2;
      ...
      //  guid.textAlignment=UITextAlignmentCenter;
        ...
        UILabel * user_intro = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30, viewWidth/2, viewHeight/28)]autorelease];
        ...
        UILabel * user_introPlus = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30+viewHeight/45, viewWidth/2, viewHeight/28)]autorelease];
        ...
        //如何快速找到要推荐的业务标题
        UILabel * quickFind = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30+viewHeight/15+viewHeight/25, viewWidth, viewHeight/30)]autorelease];
        ...
        UILabel * findGuid = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/25, viewWidth/2, viewHeight/28)]autorelease];
        ...
        //收藏夹有什么用标题
        UILabel * favorite = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/33+viewHeight/15+viewHeight/20+viewHeight/10, viewWidth, viewHeight/30)]autorelease];
        ...
        UILabel * favorite_intro = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30, viewWidth/2, viewHeight/28)]autorelease];
        ...
        //如何把业务添加到收藏夹标题
        UILabel * favorite_op = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/5+viewHeight/15+viewHeight/23+viewHeight/25, viewWidth, viewHeight/30)]autorelease];
        ...
        UILabel * favorite_opIntro = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30, viewWidth/2, viewHeight/28)]autorelease];
        ...
        //什么是热点业务标题
        UILabel * hot_busi = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/10+viewHeight/5+viewHeight/10+viewHeight/15+viewHeight/60, viewWidth, viewHeight/30)]autorelease];
        ...
        UILabel * hot_intro = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30, viewWidth/2, viewHeight/28)]autorelease];
        ...
        //如何更新软件标题
        UILabel * update = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/10+viewHeight/5+viewHeight/10+viewHeight/20+viewHeight/16+viewHeight/20+viewHeight/50, viewWidth, viewHeight/30)]autorelease];
        update.text = @"   如何更新软件";
        //update.font=font2;
        ...
        UILabel * update_intro = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30, viewWidth/2, viewHeight/28)]autorelease];
        ...
        UILabel * tell = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/5+viewHeight/5+viewHeight/15+viewHeight/22+viewHeight/5+viewHeight/30, viewWidth, viewHeight/30)]autorelease];
        tell.text = @"   把您的想法告诉我们";
        //tell.font=font2;
        ...
        UILabel * tellUs = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30, viewWidth/2, viewHeight/20)]autorelease];
