...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        //平台介绍标题
        UILabel * platform = [[[UILabel alloc]initWithFrame:CGRectMake(0, 0, viewWidth, viewHeight/30)]autorelease];
        platform.text = @"   平台介绍";
        ...
        UILabel * intro = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30, viewWidth/2, viewHeight/28)]autorelease];
        ...
        UILabel *platform_intro=[[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30+viewHeight/28, viewWidth, viewHeight/20)]autorelease];
    platform_intro.text=@"乐享100能够对营销人员的业务推荐办理结果进行记录、考核、定期给营销人员结算相应的酬金；从而提升营销人员推荐办理业务的积极性、进一步提高电子渠道的业务办理量和使用普及率，能够有效缓解实体渠道的压力，增强电子渠道的分流能力。";
        ...
        UILabel * platform_chara = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/30+viewHeight/5, viewWidth/2, viewHeight/28)]autorelease];
        ...
        UILabel *platform_charaIntro=[[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/20+viewHeight/15, viewWidth/2, viewHeight/28)]autorelease];
        ...
        //短信端口标题
        UILabel * message = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/4+viewHeight/10, viewWidth, viewHeight/30)]autorelease];
        message.text = @"   短信端口";
        ...
        UILabel *platform_message=[[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/4+viewHeight/10+viewHeight/30, viewWidth/2, viewHeight/28)]autorelease];
        ...
        //客服电话标题
        UILabel * tel = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/4+viewHeight/10+viewHeight/13, viewWidth, viewHeight/30)]autorelease];
        tel.text = @"   客服电话";
        ...
        UILabel *tel_num=[[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/4+viewHeight/10+viewHeight/15, viewWidth/2, viewHeight/28)]autorelease];
        ...
        //官方网站标题
        UILabel * web = [[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/4+viewHeight/10+viewHeight/17+viewHeight/10, viewWidth, viewHeight/30)]autorelease];
        web.text = @"   官方网站";
        ...
        UILabel *website=[[[UILabel alloc]initWithFrame:CGRectMake(0, viewHeight/4+viewHeight/10+viewHeight/25+viewHeight/10+viewHeight/50, viewWidth/2, viewHeight/28)]autorelease];
